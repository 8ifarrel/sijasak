{{-- START JANGAN DIHAPUS DAN JANGAN DIUBAH 
<div class="sticky top-0 inset-x-0 flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full text-sm">
  <nav class="mt-4 relative max-w-2xl w-full bg-white border border-gray-200 rounded-full mx-2 py-2.5 md:flex md:items-center md:justify-between md:py-0 md:pe-2 md:ps-4 md:mx-auto dark:bg-neutral-900 dark:border-neutral-700">
    <div class="px-4 md:px-0 flex justify-between items-center">
      <div class="flex items-center">
        <a class="flex-none text-xl inline-block font-semibold focus:outline-hidden focus:opacity-80" href="../templates/personal/index.html" aria-label="Preline">
      ...
      <div class="md:hidden flex items-center space-x-2">
		<a type="button" class="py-1.5 px-3 inline-flex items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent bg-kuning text-biru hover:bg-biru hover:text-kuning focus:outline-hidden foucs:bg-biru foucs:text-kuning disabled:opacity-50 disabled:pointer-events-none">
  			Adukan Jalan Rusak
		</a>
    ...
    <div id="hs-navbar-header-floating" class="hidden hs-collapse overflow-hidden transition-all duration-300 basis-full grow md:block" aria-labelledby="hs-navbar-header-floating-collapse">
      <div class="flex flex-col md:flex-row md:items-center md:justify-end gap-2 md:gap-3 mt-3 md:mt-0 py-2 md:py-0 md:ps-7">
        <a class="py-0.5 md:py-3 px-4 md:px-1 border-s-2 md:border-s-0 md:border-b-2 border-gray-800 font-medium text-gray-800 focus:outline-hidden dark:border-neutral-200 dark:text-neutral-200" href="#" aria-current="page">Beranda</a>
        <a class="py-0.5 md:py-3 px-4 md:px-1 border-s-2 md:border-s-0 md:border-b-2 border-transparent text-gray-500 hover:text-gray-800 focus:outline-hidden dark:text-neutral-400 dark:hover:text-neutral-200" href="#">Soon</a>
        <a class="py-0.5 md:py-3 px-4 md:px-1 border-s-2 md:border-s-0 md:border-b-2 border-transparent text-gray-500 hover:text-gray-800 focus:outline-hidden dark:text-neutral-400 dark:hover:text-neutral-200" href="#">Soon</a>
		<a type="button" class="hidden md:block py-1.5 px-3 items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent bg-kuning text-biru hover:bg-biru hover:text-kuning focus:outline-hidden foucs:bg-biru foucs:text-kuning disabled:opacity-50 disabled:pointer-events-none">
  			Adukan Jalan Rusak
		</a>
      </div>
    </div>
...
END JANGAN DIHAPUS DAN JANGAN DIUBAH--}}

<div class="sticky top-0 inset-x-0 flex justify-center md:justify-start z-10 w-full text-sm">
    <div class="m-4 relative w-full md:max-w-sm">
        <div class="sticky">
            <div class="relative"
                data-hs-combo-box='{
                ...
                <div class="relative">
                    <button class="absolute inset-y-0 start-0 flex items-center z-50 ps-3.5" aria-haspopup="dialog" aria-expanded="false" aria-controls="hs-sidebar-offcanvas" aria-label="Toggle navigation" data-hs-overlay="#hs-sidebar-offcanvas">
                    ...
                    <input
                        class="py-2.5 py-3 ps-10 pe-10 block w-full border-gray-200 rounded-full sm:text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none bg-white z-10"
                        type="text" role="combobox" aria-expanded="false" placeholder="Cari nama jalan"
...
<div id="hs-sidebar-offcanvas" class="hs-overlay w-64 hs-overlay-open:translate-x-0 -translate-x-full transition-all duration-300 transform h-full hidden fixed top-0 start-0 bottom-0 z-60 bg-white border-e border-gray-200" role="dialog" tabindex="-1" aria-label="Sidebar" >
  <div class="relative flex flex-col h-full max-h-full ">
      <header class="p-4 flex justify-between items-center gap-x-2">
        ...
        <div class="-me-2">
          <button type="button" class="flex justify-center items-center gap-x-3 size-6 bg-white border border-gray-200 text-sm text-gray-600 hover:bg-gray-100 rounded-full disabled:opacity-50 disabled:pointer-events-none focus:outline-hidden focus:bg-gray-100" data-hs-overlay="#hs-sidebar-offcanvas">
