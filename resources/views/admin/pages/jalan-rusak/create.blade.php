      ...
      selectLocBtn.addEventListener('click', function() {
        ...
        setTimeout(() => {
          if (!mapView) {
            require([
            ...
            ], function(Map, MapView, Locate, ScaleBar, Compass, Search, BasemapGallery, Graphic,
              GraphicsLayer) {
              const map = new Map({
                basemap: "hybrid"
              });
              ...
              mapView = new MapView({
                ...
                map: map,
                center: [
                  parseFloat(document.getElementById('longitude').value) || 117.1466,
                  parseFloat(document.getElementById('latitude').value) || -0.5022
                ],
                zoom: 12
              });
              ...
              if (document.getElementById('longitude').value && document.getElementById('latitude')
                .value) {
