...
@section('slot')
  <div
    class="flex-auto w-full sm:w-[calc(100vw_-_16rem)] h-[calc(var(--vh,_1vh)*100_-_69px)] sm:h-[calc(100vh_-_56px)] absolute bottom-0 right-0">
                ...
                <tr>
                  ...
                  <td>
                    <div class="foto-viewer-wrapper" style="display:inline-block;">
                      <img src="{{ asset('storage/' . $item->foto) }}" alt="Foto Jalan Rusak"
                        class="rounded-lg foto-viewer-img"
