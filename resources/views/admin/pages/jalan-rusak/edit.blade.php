                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-3">
                        ...
                        <div>
                            ...
                            <select id="tingkat_keparahan" name="tingkat_keparahan" required
                                class="w-full rounded-lg border border-gray-300 bg-white focus:border-primary-500 focus:ring-primary-500 transition px-3 py-2">
                                <option value="ringan" {{ old('tingkat_keparahan', $jalan_rusak->tingkat_keparahan) ==
                                    'ringan' ? 'selected' : '' }}>Ringan</option>
                                <option value="sedang" {{ old('tingkat_keparahan', $jalan_rusak->tingkat_keparahan) ==
                                    'sedang' ? 'selected' : '' }}>Sedang</option>
                                <option value="berat" {{ old('tingkat_keparahan', $jalan_rusak->tingkat_keparahan) ==
                        ...
                        <div>
                            ...
                            <select id="sudah_diperbaiki" name="sudah_diperbaiki" required
                                class="w-full rounded-lg border border-gray-300 bg-white focus:border-primary-500 focus:ring-primary-500 transition px-3 py-2">
                                <option value="0" {{ old('sudah_diperbaiki', $jalan_rusak->sudah_diperbaiki) == 0 ?
                                    'selected' : '' }}>Belum diperbaiki</option>
                                <option value="1" {{ old('sudah_diperbaiki', $jalan_rusak->sudah_diperbaiki) == 1 ?
            ...
            if (navigator.geolocation) {
                navigator.geolocation.getCurrentPosition(
                    function(position) {
                        ...
                        detectBtn.innerHTML = '<i class="fa-solid fa-location-crosshairs mr-1"></i>Deteksi dari GPS';
            ...
            if (!mapView) {
              require([
                ...
                mapView = new MapView({
                  ...
                  map: map,
                  center: [
                    parseFloat(longitudeInput.value) || 117.1466,
